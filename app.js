$(document).ready(function() {
  ...
  // Buffers to store places popups generated by search function
  let popups = [];
  let places = [];

  // Helper functions for clearing
  ...
  // Helper function to push data from features results into places buffer
  ...
  // Helper function to append result of id=id to sidebar
